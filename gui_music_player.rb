...
class MusicPlayerMain < Gosu::Window
	...
	def road_album #road = load and read 
		...
		puts "there are #{albums.length} albums to play"
		# albums.each do |current_album|
		# 	puts current_album.title
		# # 	@track_id = track_id
		# # @title = title
		# # @artist = artist
		# # @art = art
